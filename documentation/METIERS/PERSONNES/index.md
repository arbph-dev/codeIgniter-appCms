...
| fichier | staut | Notes |
| --- | --- | --- |
| [personne](/documentation/METIERS/PERSONNES/personne.md) | à réviser | element principal. Contrainte :  prenom a créér |
| [personne_alias](/documentation/METIERS/PERSONNES/personne_alias.md) | à réviser | Une personne peut avoir un nom de scène : Johny Halliday et Philipe SMET |
| [personne_distinctions](/documentation/METIERS/PERSONNES/personne_distinctions.md) | à réviser | element principal. Contrainte : prenom a créér |
| [personne_ideologies](/documentation/METIERS/PERSONNES/personne_ideologies.md) | à réviser | table réductrice pour certains, luxueuse pour d'autres |
| [personne_migration.sql](/documentation/METIERS/PERSONNES/personne_migration.sql) | à réviser | Migration des tables a compléter avec un seeder |
| [personne_parcours](/documentation/METIERS/PERSONNES/personne_parcours.md) | à réviser | un parcours n’est PAS une relation c’est un évènement temporel. |
| [personne_relations](/documentation/METIERS/PERSONNES/personne_relations.md) | à réviser | relations d'une personne, voir [relation_types](/project/PERSONNES/relation_types.md) |
| [prenom](/documentation/METIERS/PERSONNES/prenom.md) | à réviser | prenom a créér depuis la table mot |
| [relation_types](/documentation/METIERS/PERSONNES/relation_types.md) | à réviser | définit le srelations entre personnes et organisations |
