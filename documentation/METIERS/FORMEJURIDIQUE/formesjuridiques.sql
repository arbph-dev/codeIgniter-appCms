-- ============================================================
-- formesjuridiques — 260 codes INSEE (catjurique2022.csv)
-- À exécuter dans phpMyAdmin ou via CLI MySQL
-- ============================================================

CREATE TABLE IF NOT EXISTS `formesjuridiques` (
  `id`          CHAR(4)      NOT NULL COMMENT 'Code INSEE à 4 chiffres (0000-9970)',
  `description` VARCHAR(200) NOT NULL COMMENT 'Libellé complet INSEE',
  `created_at`  TIMESTAMP    NULL DEFAULT NULL,
  `updated_at`  TIMESTAMP    NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_description` (`description`(50))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  COMMENT='Formes juridiques INSEE — catjurique2022';

-- ------------------------------------------------------------
-- Données
-- ------------------------------------------------------------
INSERT INTO `formesjuridiques` (`id`, `description`) VALUES
