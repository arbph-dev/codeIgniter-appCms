...
| ---------- | ------------------------------------------------------------ | --------------------------------------- |
| categories | id (PK), title, slug, description, catp_id (nullable FK)     | Catégories et sous-catégories           |
| articles   | id (PK), title, slug, description, cat_id (FK), is_published | Articles liés à une catégorie           |
