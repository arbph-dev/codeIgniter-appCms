...
## Coût de maintenance
Calculé à partir des [[METIERS/maintenance/GMAO/intervention|intervention]]
...
[[METIERS/maintenance/GMAO/manufact|GMAO/manufact]]
1    
|    
n
[[METIERS/maintenance/GMAO/equipement|GMAO/equipement]]
+---- TypeEquipement    
+---- ConsigneSecurite    
+---- Equipement Parent
...
├── Constructeur
	...
	voir [[METIERS/maintenance/GMAO/manufact|GMAO/manufact]]
├── Type équipement
	via : typid  -> typeeqp.id 
	voir [[METIERS/maintenance/GMAO/typeeqp|GMAO/typeeqp]]
├── Consigne sécurité
	via : cnsid  -> cnssec
└── Equipement parent
