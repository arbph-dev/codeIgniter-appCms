...
### Fichiers
- `app/Entities/ParcoursType.php` — cast `id` uniquement, pas de `$dates` métier
- `app/Models/ParcoursTypeModel.php` — `findByCode()` + `toList()` au-delà du CRUD
- `app/Controllers/Api/ParcoursTypes.php` — lecture seule, filtre `?code=`
...
### Fichiers
- `app/Entities/RelationType.php` — cast `symetrique` en `boolean` (`tinyint(1) NOT NULL DEFAULT 0`)
...
- `app/Controllers/Api/RelationTypes.php` — lecture seule, filtre `?source_type=&target_type=`
...
**Fichier :** `app/Services/RelationService.php`
...
**Fichier :** `app/Controllers/Api/Relations.php`
...
**Fichier :** `app/Services/PersonneService.php`
...
### Bloc `parcours_types`
- `app/Entities/ParcoursType.php`
- `app/Models/ParcoursTypeModel.php`
...
- `app/Entities/Relation.php`
- `app/Models/RelationModel.php`
- `app/Services/RelationService.php`
...
- [ ] Exécuter la migration ALTER TABLE `relations` (Option A)
- [ ] Enregistrer `RelationService` dans `app/Config/Services.php`
