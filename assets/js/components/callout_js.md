...
[/refactoring/assets/css/components/callout.css](/refactoring/assets/css/components/callout.css)
...
Code généré
```html
<div id="CO_1" class="cp_callout cp_callout--warning" data-callout-init="1">
...
ajout de variable a definir selon theme
```
        --col-danger           : #f01313;
